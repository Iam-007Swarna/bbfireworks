    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 grid-cols-[repeat(auto-fill,minmax(220px,1fr))]">
        {products.map((p) => {
          ...
          if (price?.sellPerPack) displayPrice = inr.format(Number(price.sellPerPack));
          else if (price?.sellPerPiece) displayPrice = inr.format(Number(price.sellPerPiece));
          else if (price?.sellPerBox) displayPrice = inr.format(Number(price.sellPerBox));
